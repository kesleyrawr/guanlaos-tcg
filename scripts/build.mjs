...
const assets = ['styles.css', 'retro-polish.css', 'app.js', 'api-hook.js', 'search-render-guard.js', 'search-freeze.js', 'card-search-fix.js', 'collection-edit.js', 'dashboard-cleanup.js', 'ui-cleanup.js', 'collection-dashboard-ui.js'];
